ActiveAdmin.register Assessment do
  ...
  index do
    ...
    # Add the filter button and sliding panel
    #panel "Filters", class: "filters-panel", id: "filter-panel", style: "display:none;" do
    #  render partial: 'assessment/filters', locals: { search: Assessment.ransack(params[:q]) }
    #end
#
    #action_item :filter, only: :index do
    #  link_to 'Show Filters', '#', id: 'filter-button', class: 'button'
    #end
  end
