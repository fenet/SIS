...
#
# This file is the source Rails uses to define your  when running `bin/rails
# db::load`. When creating a new database, `bin/rails db::load` tends to
...
ActiveRecord::[7.0].define(version: 2023_06_27_115307) do
